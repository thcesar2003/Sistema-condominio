...
# VALORES INICIAIS DE REFERÊNCIA (01/01/2026)
SALDO_INICIAL_CONTA_01_01_2026 = 43285.00
SALDO_INICIAL_FUNDO_01_01_2026 = 55881.72
...
def calcular_cronograma_mensal(df_completo, saldo_inicial_start=43285.00, fundo_inicial_start=55881.72):
    """
    Calcula a transposição de saldos usando a totalidade dos dados (df_completo)
    garantindo que o saldo inicial de 01/01/2026 e do Fundo de Reserva sejam preservados.
    """
    ...
    for idx, mes in enumerate(meses_ordenados):
        ...
        saldo_fim_mes = saldo_ini_mes + r["resultado"]
...
with tabs[1]:
    ...
    if df_mensal_rel.empty:
        ...
        st.info(
            "📌 **Regra de Transposição**: O **Saldo Final** de 01/01/2026 (calculado a partir de R$ 43.285,00) "
            "e o **Fundo de Reserva** (iniciado em R$ 55.881,72) são transpostos mês a mês de forma encadeada."
        )
...
# ============================================================
st.markdown("---")
st.caption("San Remo • Gestão Financeira Condominial | Transposição de saldos e saldos iniciais de 2026 parametrizados.")