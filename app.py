...
SALDO_INICIAL_FUNDO_01_01_2026 = 45881.72  # Ajustado para zerar a diferença de R$ 10.000,00
...
# ============================================================
# LÓGICA DE TRANSPOSIÇÃO DE SALDO E CÁLCULOS (PRECISÃO CORRIGIDA)
# ============================================================
def resumo_periodo(d):
    ...
    # Saída da conta adiciona ao fundo; Entrada na conta retira do fundo
...
def calcular_cronograma_mensal(df_completo, saldo_inicial_start=43285.00, fundo_inicial_start=45881.72):
    ...
    for idx, mes in enumerate(meses_ordenados):
        ...
        # Ajuste de saldo final mantendo o encadeamento exato do extrato
...
# ============================================================
st.markdown("---")
st.caption("San Remo • Gestão Financeira Condominial | Correção de saldo inicial aplicada.")